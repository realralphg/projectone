    ...
    <div>
        <q-card style="width: 300px">
          <q-card-section class="q-pt-none">
            <!-- Update Fields -->
            <div class="text-weight-light text-center text-h6 text-primary">
                Withdraw
            </div>

            <q-input v-model="amount" name="amount" label="How much?"/>
            ...
            <span class="text-primary text-center"><small>Cash withdrawn is paid into this Bank Account.</small></span>
